...
[`TeamConfig`](../type-aliases/TeamConfig.md)
...
The result from the lead agent
...
[`BaseAgentConfig`](../../../agents/BaseAgent/interfaces/BaseAgentConfig.md)[]
...
[`Tool`](../../../tools/Tool/classes/Tool.md)\<`any`\>[]
