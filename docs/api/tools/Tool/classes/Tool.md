...
Generic. Format of the tool result
...
[`ToolConfig`](../interfaces/ToolConfig.md)\<`T`\>
...
[`AgentVendor`](../../../agents/AgentConfig/type-aliases/AgentVendor.md)
...
> **input\_schema**: [`ToolInputSchema`](../interfaces/ToolInputSchema.md)
...
The agent that will act as an assistant
